...
Training organized within the CRC education program can be joined only by university students, and graduates up to 2 years after graduation can join the program. The determinant is a student ID card (active) or just a graduate up to 2 years after graduation.
